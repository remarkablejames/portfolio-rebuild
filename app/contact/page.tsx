          ...
          <div className="relative items-center w-full px-5 py-12 mx-auto max-w-7xl lg:px-16 lg:py-32 md:px-12">
            <div>
              <div className="w-full mx-auto">
                <h1 className="text-4xl font-bold tracking-tight text-white/60 sm:text-5xl">
                  My Contact
                </h1>
                <div className="divide-y divide-white/25 w-fit mt-4 md:mt-10">
                  {/* Icon Block */}
                  <div className="flex gap-x-7 py-6">
                    ...
                    <div className="grow">
                      <h3 className="font-semibold text-white/70 ">Phone</h3>
                      <a
