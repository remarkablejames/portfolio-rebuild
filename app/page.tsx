              ...
              <section className="w-full flex flex-col items-center justify-center text-md">
                  <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      <div className="w-full sm:max-w-lg space-y-4">
                          ...
                          <p>
                              I’m currently building <span className="text-blue-600">SomoLabs</span>, an online learning platform that offers curriculum-aligned courses via multimedia format.
                          </p>
                          <p>
              ...
              <section className="w-full flex flex-col items-center justify-center text-md mt-12">
                  <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      <div className="w-full sm:max-w-lg">
                          ...
                          <p className="text-white/50 mt-2">Algonquin College of Applied Arts and Technology - Ottawa, ON</p>
