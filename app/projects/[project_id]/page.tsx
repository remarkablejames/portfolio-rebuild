...
export default function ProjectDetails({params}: any) {
    ...
    return (
            ...
            <div className={"w-full h-[80vh] flex items-center justify-center"}>
                <div className=" flex flex-col gap-4 items-center justify-center">
                    ...
                    <h1 className={"scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl text-center"}>
                        Code repository has been made private
                    </h1>
                    <span className={"text-lg text-muted-foreground font-semibold"}>
                        Exclusive access only to job interviewers
                    </span>
                </div>
                {/*<p>This project has been made private</p>*/}
            </div>
        ...
        {/*                                <li key={index}*/}
        {/*                                    className="inline-flex items-center gap-x-2 py-3 px-4 text-sm border border-white/25  text-white/45 -mt-px first:rounded-t-md first:mt-0 last:rounded-b-md dark:border-white/25">*/}
        {/*                                    <div className="flex items-center justify-between w-full">*/}
